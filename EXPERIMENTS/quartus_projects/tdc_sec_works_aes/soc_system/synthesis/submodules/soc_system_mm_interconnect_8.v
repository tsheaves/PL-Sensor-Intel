// soc_system_mm_interconnect_8.v
...
`timescale 1 ps / 1 ps
module soc_system_mm_interconnect_8 (
		...
		input  wire [31:0]  DMA_to_SDRAM_mm_write_address,                                      //                                        DMA_to_SDRAM_mm_write.address
		output wire         DMA_to_SDRAM_mm_write_waitrequest,                                  //                                                             .waitrequest
		input  wire [3:0]   DMA_to_SDRAM_mm_write_burstcount,                                   //                                                             .burstcount
		input  wire [31:0]  DMA_to_SDRAM_mm_write_byteenable,                                   //                                                             .byteenable
		input  wire         DMA_to_SDRAM_mm_write_write,                                        //                                                             .write
		input  wire [255:0] DMA_to_SDRAM_mm_write_writedata,                                    //                                                             .writedata
	...
	wire          dma_to_sdram_mm_write_translator_avalon_universal_master_0_waitrequest;   // DMA_to_SDRAM_mm_write_agent:av_waitrequest -> DMA_to_SDRAM_mm_write_translator:uav_waitrequest
	wire  [255:0] dma_to_sdram_mm_write_translator_avalon_universal_master_0_readdata;      // DMA_to_SDRAM_mm_write_agent:av_readdata -> DMA_to_SDRAM_mm_write_translator:uav_readdata
	wire          dma_to_sdram_mm_write_translator_avalon_universal_master_0_debugaccess;   // DMA_to_SDRAM_mm_write_translator:uav_debugaccess -> DMA_to_SDRAM_mm_write_agent:av_debugaccess
	wire   [31:0] dma_to_sdram_mm_write_translator_avalon_universal_master_0_address;       // DMA_to_SDRAM_mm_write_translator:uav_address -> DMA_to_SDRAM_mm_write_agent:av_address
	wire          dma_to_sdram_mm_write_translator_avalon_universal_master_0_read;          // DMA_to_SDRAM_mm_write_translator:uav_read -> DMA_to_SDRAM_mm_write_agent:av_read
	wire   [31:0] dma_to_sdram_mm_write_translator_avalon_universal_master_0_byteenable;    // DMA_to_SDRAM_mm_write_translator:uav_byteenable -> DMA_to_SDRAM_mm_write_agent:av_byteenable
	wire          dma_to_sdram_mm_write_translator_avalon_universal_master_0_readdatavalid; // DMA_to_SDRAM_mm_write_agent:av_readdatavalid -> DMA_to_SDRAM_mm_write_translator:uav_readdatavalid
	wire          dma_to_sdram_mm_write_translator_avalon_universal_master_0_lock;          // DMA_to_SDRAM_mm_write_translator:uav_lock -> DMA_to_SDRAM_mm_write_agent:av_lock
	wire          dma_to_sdram_mm_write_translator_avalon_universal_master_0_write;         // DMA_to_SDRAM_mm_write_translator:uav_write -> DMA_to_SDRAM_mm_write_agent:av_write
	wire  [255:0] dma_to_sdram_mm_write_translator_avalon_universal_master_0_writedata;     // DMA_to_SDRAM_mm_write_translator:uav_writedata -> DMA_to_SDRAM_mm_write_agent:av_writedata
	wire    [8:0] dma_to_sdram_mm_write_translator_avalon_universal_master_0_burstcount;    // DMA_to_SDRAM_mm_write_translator:uav_burstcount -> DMA_to_SDRAM_mm_write_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                        // rsp_mux:src_valid -> DMA_to_SDRAM_mm_write_agent:rp_valid
	wire  [363:0] rsp_mux_src_data;                                                         // rsp_mux:src_data -> DMA_to_SDRAM_mm_write_agent:rp_data
	wire          rsp_mux_src_ready;                                                        // DMA_to_SDRAM_mm_write_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                      // rsp_mux:src_channel -> DMA_to_SDRAM_mm_write_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                // rsp_mux:src_startofpacket -> DMA_to_SDRAM_mm_write_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                  // rsp_mux:src_endofpacket -> DMA_to_SDRAM_mm_write_agent:rp_endofpacket
	...
	wire          dma_to_sdram_mm_write_agent_cp_valid;                                     // DMA_to_SDRAM_mm_write_agent:cp_valid -> router:sink_valid
	wire  [363:0] dma_to_sdram_mm_write_agent_cp_data;                                      // DMA_to_SDRAM_mm_write_agent:cp_data -> router:sink_data
	wire          dma_to_sdram_mm_write_agent_cp_ready;                                     // router:sink_ready -> DMA_to_SDRAM_mm_write_agent:cp_ready
	wire          dma_to_sdram_mm_write_agent_cp_startofpacket;                             // DMA_to_SDRAM_mm_write_agent:cp_startofpacket -> router:sink_startofpacket
	wire          dma_to_sdram_mm_write_agent_cp_endofpacket;                               // DMA_to_SDRAM_mm_write_agent:cp_endofpacket -> router:sink_endofpacket
	...
	) dma_to_sdram_mm_write_translator (
		.clk                    (shell_pll_outclk0_clk),                                                    //                       clk.clk
		.reset                  (DMA_to_SDRAM_reset_n_reset_bridge_in_reset_reset),                         //                     reset.reset
		.uav_address            (dma_to_sdram_mm_write_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (dma_to_sdram_mm_write_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (dma_to_sdram_mm_write_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (dma_to_sdram_mm_write_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (dma_to_sdram_mm_write_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (dma_to_sdram_mm_write_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (dma_to_sdram_mm_write_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (dma_to_sdram_mm_write_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (dma_to_sdram_mm_write_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (dma_to_sdram_mm_write_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (dma_to_sdram_mm_write_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (DMA_to_SDRAM_mm_write_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (DMA_to_SDRAM_mm_write_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (DMA_to_SDRAM_mm_write_burstcount),                                         //                          .burstcount
		.av_byteenable          (DMA_to_SDRAM_mm_write_byteenable),                                         //                          .byteenable
		.av_write               (DMA_to_SDRAM_mm_write_write),                                              //                          .write
		.av_writedata           (DMA_to_SDRAM_mm_write_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) dma_to_sdram_mm_write_agent (
		.clk                   (shell_pll_outclk0_clk),                                                    //       clk.clk
		.reset                 (DMA_to_SDRAM_reset_n_reset_bridge_in_reset_reset),                         // clk_reset.reset
		.av_address            (dma_to_sdram_mm_write_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (dma_to_sdram_mm_write_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (dma_to_sdram_mm_write_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (dma_to_sdram_mm_write_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (dma_to_sdram_mm_write_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (dma_to_sdram_mm_write_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (dma_to_sdram_mm_write_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (dma_to_sdram_mm_write_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (dma_to_sdram_mm_write_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (dma_to_sdram_mm_write_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (dma_to_sdram_mm_write_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (dma_to_sdram_mm_write_agent_cp_valid),                                     //        cp.valid
		.cp_data               (dma_to_sdram_mm_write_agent_cp_data),                                      //          .data
		.cp_startofpacket      (dma_to_sdram_mm_write_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (dma_to_sdram_mm_write_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (dma_to_sdram_mm_write_agent_cp_ready),                                     //          .ready
	...
	soc_system_mm_interconnect_8_router router (
		.sink_ready         (dma_to_sdram_mm_write_agent_cp_ready),             //      sink.ready
		.sink_valid         (dma_to_sdram_mm_write_agent_cp_valid),             //          .valid
		.sink_data          (dma_to_sdram_mm_write_agent_cp_data),              //          .data
		.sink_startofpacket (dma_to_sdram_mm_write_agent_cp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (dma_to_sdram_mm_write_agent_cp_endofpacket),       //          .endofpacket
		.clk                (shell_pll_outclk0_clk),                            //       clk.clk
		.reset              (DMA_to_SDRAM_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_8_router_001 router_001 (
	...
	soc_system_mm_interconnect_8_cmd_demux cmd_demux (
		.clk                (shell_pll_outclk0_clk),                            //       clk.clk
		.reset              (DMA_to_SDRAM_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_8_cmd_mux cmd_mux (
		.clk                 (shell_pll_outclk0_clk),                                              //       clk.clk
		.reset               (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_8_cmd_demux rsp_demux (
		.clk                (shell_pll_outclk0_clk),                                              //       clk.clk
		.reset              (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_8_rsp_mux rsp_mux (
		.clk                 (shell_pll_outclk0_clk),                            //       clk.clk
		.reset               (DMA_to_SDRAM_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_8_avalon_st_adapter #(
		.inBitsPerSymbol (258),
		.inUsePackets    (0),
		.inDataWidth     (258),
		.inChannelWidth  (0),
