...
#define IP_SYNC_NIOSV_NIOSV_RESET_PIO_FREQ 100000000
...
/*
 * Macros for device 'ip_sync_niosv', class 'ip_sync'
 * Path to the device is from the master group 'ipsync_bridge_niosv'.
 * The macros are prefixed with 'IPSYNC_BRIDGE_NIOSV_IP_SYNC_NIOSV_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define IPSYNC_BRIDGE_NIOSV_IP_SYNC_NIOSV_COMPONENT_TYPE ip_sync
#define IPSYNC_BRIDGE_NIOSV_IP_SYNC_NIOSV_COMPONENT_NAME ip_sync_niosv
#define IPSYNC_BRIDGE_NIOSV_IP_SYNC_NIOSV_BASE 0x0
#define IPSYNC_BRIDGE_NIOSV_IP_SYNC_NIOSV_SPAN 1024
#define IPSYNC_BRIDGE_NIOSV_IP_SYNC_NIOSV_END 0x3ff

/*
 * Macros for device 'niosv_reset_pio', class 'altera_avalon_pio'
 * Path to the device is from the master group 'ipsync_to_niosv_delay'.
 * The macros are prefixed with 'IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_COMPONENT_TYPE altera_avalon_pio
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_COMPONENT_NAME niosv_reset_pio
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_BASE 0x0
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_SPAN 16
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_END 0xf
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_CAPTURE 0
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_DATA_WIDTH 32
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_DO_TEST_BENCH_WIRING 0
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_DRIVEN_SIM_VALUE 0
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_EDGE_TYPE NONE
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_FREQ 100000000
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_HAS_IN 0
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_HAS_OUT 1
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_HAS_TRI 0
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_IRQ_TYPE NONE
#define IPSYNC_TO_NIOSV_DELAY_NIOSV_RESET_PIO_RESET_VALUE 0
