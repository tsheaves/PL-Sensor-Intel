	soc_system u0 (
		...
		.niosv_reset_in_reset    (<connected-to-niosv_reset_in_reset>),    //    niosv_reset_in.reset
		.niosv_reset_out_export  (<connected-to-niosv_reset_out_export>),  //   niosv_reset_out.export
