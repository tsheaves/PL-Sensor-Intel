 ...
 * Path to the device is from the master group 'hps_0'.
 * The macros are prefixed with 'HPS_0_IP_SYNC_ORCA_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define HPS_0_IP_SYNC_ORCA_COMPONENT_TYPE ip_sync
#define HPS_0_IP_SYNC_ORCA_COMPONENT_NAME ip_sync_orca
#define HPS_0_IP_SYNC_ORCA_BASE 0x1000c00
#define HPS_0_IP_SYNC_ORCA_SPAN 1024
#define HPS_0_IP_SYNC_ORCA_END 0x1000fff
...
/*
 * Macros for device 'uc_data_mem', class 'altera_avalon_onchip_memory2'
 * Path to the device is from the master group 'hps_0'.
 * The macros are prefixed with 'HPS_0_UC_DATA_MEM_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define HPS_0_UC_DATA_MEM_COMPONENT_TYPE altera_avalon_onchip_memory2
#define HPS_0_UC_DATA_MEM_COMPONENT_NAME uc_data_mem
#define HPS_0_UC_DATA_MEM_BASE 0x1002000
#define HPS_0_UC_DATA_MEM_SPAN 2048
#define HPS_0_UC_DATA_MEM_END 0x10027ff
#define HPS_0_UC_DATA_MEM_ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR 0
#define HPS_0_UC_DATA_MEM_ALLOW_MRAM_SIM_CONTENTS_ONLY_FILE 0
#define HPS_0_UC_DATA_MEM_CONTENTS_INFO ""
#define HPS_0_UC_DATA_MEM_DUAL_PORT 1
#define HPS_0_UC_DATA_MEM_GUI_RAM_BLOCK_TYPE AUTO
#define HPS_0_UC_DATA_MEM_INIT_CONTENTS_FILE soc_system_uc_data_mem
#define HPS_0_UC_DATA_MEM_INIT_MEM_CONTENT 1
#define HPS_0_UC_DATA_MEM_INSTANCE_ID NONE
#define HPS_0_UC_DATA_MEM_NON_DEFAULT_INIT_FILE_ENABLED 0
#define HPS_0_UC_DATA_MEM_RAM_BLOCK_TYPE AUTO
#define HPS_0_UC_DATA_MEM_READ_DURING_WRITE_MODE DONT_CARE
#define HPS_0_UC_DATA_MEM_SINGLE_CLOCK_OP 0
#define HPS_0_UC_DATA_MEM_SIZE_MULTIPLE 1
#define HPS_0_UC_DATA_MEM_SIZE_VALUE 2048
#define HPS_0_UC_DATA_MEM_WRITABLE 1
#define HPS_0_UC_DATA_MEM_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define HPS_0_UC_DATA_MEM_MEMORY_INFO_GENERATE_DAT_SYM 1
#define HPS_0_UC_DATA_MEM_MEMORY_INFO_GENERATE_HEX 1
#define HPS_0_UC_DATA_MEM_MEMORY_INFO_HAS_BYTE_LANE 0
#define HPS_0_UC_DATA_MEM_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define HPS_0_UC_DATA_MEM_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define HPS_0_UC_DATA_MEM_MEMORY_INFO_MEM_INIT_FILENAME soc_system_uc_data_mem
 ...
 * Macros for device 'ip_sync_orca', class 'ip_sync'
 * Path to the device is from the master group 'hps_0_bridges'.
 * The macros are prefixed with 'HPS_0_BRIDGES_IP_SYNC_ORCA_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define HPS_0_BRIDGES_IP_SYNC_ORCA_COMPONENT_TYPE ip_sync
#define HPS_0_BRIDGES_IP_SYNC_ORCA_COMPONENT_NAME ip_sync_orca
#define HPS_0_BRIDGES_IP_SYNC_ORCA_BASE 0x1000c00
#define HPS_0_BRIDGES_IP_SYNC_ORCA_SPAN 1024
#define HPS_0_BRIDGES_IP_SYNC_ORCA_END 0x1000fff
 ...
 * Macros for device 'uc_data_mem', class 'altera_avalon_onchip_memory2'
 * Path to the device is from the master group 'hps_0_bridges'.
 * The macros are prefixed with 'HPS_0_BRIDGES_UC_DATA_MEM_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define HPS_0_BRIDGES_UC_DATA_MEM_COMPONENT_TYPE altera_avalon_onchip_memory2
#define HPS_0_BRIDGES_UC_DATA_MEM_COMPONENT_NAME uc_data_mem
#define HPS_0_BRIDGES_UC_DATA_MEM_BASE 0x1002000
#define HPS_0_BRIDGES_UC_DATA_MEM_SPAN 2048
#define HPS_0_BRIDGES_UC_DATA_MEM_END 0x10027ff
#define HPS_0_BRIDGES_UC_DATA_MEM_ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR 0
#define HPS_0_BRIDGES_UC_DATA_MEM_ALLOW_MRAM_SIM_CONTENTS_ONLY_FILE 0
#define HPS_0_BRIDGES_UC_DATA_MEM_CONTENTS_INFO ""
#define HPS_0_BRIDGES_UC_DATA_MEM_DUAL_PORT 1
#define HPS_0_BRIDGES_UC_DATA_MEM_GUI_RAM_BLOCK_TYPE AUTO
#define HPS_0_BRIDGES_UC_DATA_MEM_INIT_CONTENTS_FILE soc_system_uc_data_mem
#define HPS_0_BRIDGES_UC_DATA_MEM_INIT_MEM_CONTENT 1
#define HPS_0_BRIDGES_UC_DATA_MEM_INSTANCE_ID NONE
#define HPS_0_BRIDGES_UC_DATA_MEM_NON_DEFAULT_INIT_FILE_ENABLED 0
#define HPS_0_BRIDGES_UC_DATA_MEM_RAM_BLOCK_TYPE AUTO
#define HPS_0_BRIDGES_UC_DATA_MEM_READ_DURING_WRITE_MODE DONT_CARE
#define HPS_0_BRIDGES_UC_DATA_MEM_SINGLE_CLOCK_OP 0
#define HPS_0_BRIDGES_UC_DATA_MEM_SIZE_MULTIPLE 1
#define HPS_0_BRIDGES_UC_DATA_MEM_SIZE_VALUE 2048
#define HPS_0_BRIDGES_UC_DATA_MEM_WRITABLE 1
#define HPS_0_BRIDGES_UC_DATA_MEM_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define HPS_0_BRIDGES_UC_DATA_MEM_MEMORY_INFO_GENERATE_DAT_SYM 1
#define HPS_0_BRIDGES_UC_DATA_MEM_MEMORY_INFO_GENERATE_HEX 1
#define HPS_0_BRIDGES_UC_DATA_MEM_MEMORY_INFO_HAS_BYTE_LANE 0
#define HPS_0_BRIDGES_UC_DATA_MEM_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define HPS_0_BRIDGES_UC_DATA_MEM_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define HPS_0_BRIDGES_UC_DATA_MEM_MEMORY_INFO_MEM_INIT_FILENAME soc_system_uc_data_mem
 ...
 * Macros for device 'ip_sync_orca', class 'ip_sync'
 * Path to the device is from the master group 'hps_0_arm_a9_0'.
 * The macros are prefixed with 'HPS_0_ARM_A9_0_IP_SYNC_ORCA_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define HPS_0_ARM_A9_0_IP_SYNC_ORCA_COMPONENT_TYPE ip_sync
#define HPS_0_ARM_A9_0_IP_SYNC_ORCA_COMPONENT_NAME ip_sync_orca
#define HPS_0_ARM_A9_0_IP_SYNC_ORCA_BASE 0xc1000c00
#define HPS_0_ARM_A9_0_IP_SYNC_ORCA_SPAN 1024
#define HPS_0_ARM_A9_0_IP_SYNC_ORCA_END 0xc1000fff
 ...
 * Macros for device 'uc_data_mem', class 'altera_avalon_onchip_memory2'
 * Path to the device is from the master group 'hps_0_arm_a9_0'.
 * The macros are prefixed with 'HPS_0_ARM_A9_0_UC_DATA_MEM_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define HPS_0_ARM_A9_0_UC_DATA_MEM_COMPONENT_TYPE altera_avalon_onchip_memory2
#define HPS_0_ARM_A9_0_UC_DATA_MEM_COMPONENT_NAME uc_data_mem
#define HPS_0_ARM_A9_0_UC_DATA_MEM_BASE 0xc1002000
#define HPS_0_ARM_A9_0_UC_DATA_MEM_SPAN 2048
#define HPS_0_ARM_A9_0_UC_DATA_MEM_END 0xc10027ff
#define HPS_0_ARM_A9_0_UC_DATA_MEM_ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR 0
#define HPS_0_ARM_A9_0_UC_DATA_MEM_ALLOW_MRAM_SIM_CONTENTS_ONLY_FILE 0
#define HPS_0_ARM_A9_0_UC_DATA_MEM_CONTENTS_INFO ""
#define HPS_0_ARM_A9_0_UC_DATA_MEM_DUAL_PORT 1
#define HPS_0_ARM_A9_0_UC_DATA_MEM_GUI_RAM_BLOCK_TYPE AUTO
#define HPS_0_ARM_A9_0_UC_DATA_MEM_INIT_CONTENTS_FILE soc_system_uc_data_mem
#define HPS_0_ARM_A9_0_UC_DATA_MEM_INIT_MEM_CONTENT 1
#define HPS_0_ARM_A9_0_UC_DATA_MEM_INSTANCE_ID NONE
#define HPS_0_ARM_A9_0_UC_DATA_MEM_NON_DEFAULT_INIT_FILE_ENABLED 0
#define HPS_0_ARM_A9_0_UC_DATA_MEM_RAM_BLOCK_TYPE AUTO
#define HPS_0_ARM_A9_0_UC_DATA_MEM_READ_DURING_WRITE_MODE DONT_CARE
#define HPS_0_ARM_A9_0_UC_DATA_MEM_SINGLE_CLOCK_OP 0
#define HPS_0_ARM_A9_0_UC_DATA_MEM_SIZE_MULTIPLE 1
#define HPS_0_ARM_A9_0_UC_DATA_MEM_SIZE_VALUE 2048
#define HPS_0_ARM_A9_0_UC_DATA_MEM_WRITABLE 1
#define HPS_0_ARM_A9_0_UC_DATA_MEM_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define HPS_0_ARM_A9_0_UC_DATA_MEM_MEMORY_INFO_GENERATE_DAT_SYM 1
#define HPS_0_ARM_A9_0_UC_DATA_MEM_MEMORY_INFO_GENERATE_HEX 1
#define HPS_0_ARM_A9_0_UC_DATA_MEM_MEMORY_INFO_HAS_BYTE_LANE 0
#define HPS_0_ARM_A9_0_UC_DATA_MEM_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define HPS_0_ARM_A9_0_UC_DATA_MEM_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define HPS_0_ARM_A9_0_UC_DATA_MEM_MEMORY_INFO_MEM_INIT_FILENAME soc_system_uc_data_mem
 ...
 * Macros for device 'ip_sync_orca', class 'ip_sync'
 * Path to the device is from the master group 'hps_0_arm_a9_1'.
 * The macros are prefixed with 'HPS_0_ARM_A9_1_IP_SYNC_ORCA_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define HPS_0_ARM_A9_1_IP_SYNC_ORCA_COMPONENT_TYPE ip_sync
#define HPS_0_ARM_A9_1_IP_SYNC_ORCA_COMPONENT_NAME ip_sync_orca
#define HPS_0_ARM_A9_1_IP_SYNC_ORCA_BASE 0xc1000c00
#define HPS_0_ARM_A9_1_IP_SYNC_ORCA_SPAN 1024
#define HPS_0_ARM_A9_1_IP_SYNC_ORCA_END 0xc1000fff
 ...
 * Macros for device 'uc_data_mem', class 'altera_avalon_onchip_memory2'
 * Path to the device is from the master group 'hps_0_arm_a9_1'.
 * The macros are prefixed with 'HPS_0_ARM_A9_1_UC_DATA_MEM_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define HPS_0_ARM_A9_1_UC_DATA_MEM_COMPONENT_TYPE altera_avalon_onchip_memory2
#define HPS_0_ARM_A9_1_UC_DATA_MEM_COMPONENT_NAME uc_data_mem
#define HPS_0_ARM_A9_1_UC_DATA_MEM_BASE 0xc1002000
#define HPS_0_ARM_A9_1_UC_DATA_MEM_SPAN 2048
#define HPS_0_ARM_A9_1_UC_DATA_MEM_END 0xc10027ff
#define HPS_0_ARM_A9_1_UC_DATA_MEM_ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR 0
#define HPS_0_ARM_A9_1_UC_DATA_MEM_ALLOW_MRAM_SIM_CONTENTS_ONLY_FILE 0
#define HPS_0_ARM_A9_1_UC_DATA_MEM_CONTENTS_INFO ""
#define HPS_0_ARM_A9_1_UC_DATA_MEM_DUAL_PORT 1
#define HPS_0_ARM_A9_1_UC_DATA_MEM_GUI_RAM_BLOCK_TYPE AUTO
#define HPS_0_ARM_A9_1_UC_DATA_MEM_INIT_CONTENTS_FILE soc_system_uc_data_mem
#define HPS_0_ARM_A9_1_UC_DATA_MEM_INIT_MEM_CONTENT 1
#define HPS_0_ARM_A9_1_UC_DATA_MEM_INSTANCE_ID NONE
#define HPS_0_ARM_A9_1_UC_DATA_MEM_NON_DEFAULT_INIT_FILE_ENABLED 0
#define HPS_0_ARM_A9_1_UC_DATA_MEM_RAM_BLOCK_TYPE AUTO
#define HPS_0_ARM_A9_1_UC_DATA_MEM_READ_DURING_WRITE_MODE DONT_CARE
#define HPS_0_ARM_A9_1_UC_DATA_MEM_SINGLE_CLOCK_OP 0
#define HPS_0_ARM_A9_1_UC_DATA_MEM_SIZE_MULTIPLE 1
#define HPS_0_ARM_A9_1_UC_DATA_MEM_SIZE_VALUE 2048
#define HPS_0_ARM_A9_1_UC_DATA_MEM_WRITABLE 1
#define HPS_0_ARM_A9_1_UC_DATA_MEM_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define HPS_0_ARM_A9_1_UC_DATA_MEM_MEMORY_INFO_GENERATE_DAT_SYM 1
#define HPS_0_ARM_A9_1_UC_DATA_MEM_MEMORY_INFO_GENERATE_HEX 1
#define HPS_0_ARM_A9_1_UC_DATA_MEM_MEMORY_INFO_HAS_BYTE_LANE 0
#define HPS_0_ARM_A9_1_UC_DATA_MEM_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define HPS_0_ARM_A9_1_UC_DATA_MEM_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define HPS_0_ARM_A9_1_UC_DATA_MEM_MEMORY_INFO_MEM_INIT_FILENAME soc_system_uc_data_mem
 ...
 * Path to the device is from the master group 'ip_sync_orca'.
 * The macros are prefixed with 'IP_SYNC_ORCA_ORCA_RESET_PIO_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define IP_SYNC_ORCA_ORCA_RESET_PIO_COMPONENT_TYPE altera_avalon_pio
#define IP_SYNC_ORCA_ORCA_RESET_PIO_COMPONENT_NAME orca_reset_pio
#define IP_SYNC_ORCA_ORCA_RESET_PIO_BASE 0x0
#define IP_SYNC_ORCA_ORCA_RESET_PIO_SPAN 16
#define IP_SYNC_ORCA_ORCA_RESET_PIO_END 0xf
#define IP_SYNC_ORCA_ORCA_RESET_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define IP_SYNC_ORCA_ORCA_RESET_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define IP_SYNC_ORCA_ORCA_RESET_PIO_CAPTURE 0
#define IP_SYNC_ORCA_ORCA_RESET_PIO_DATA_WIDTH 32
#define IP_SYNC_ORCA_ORCA_RESET_PIO_DO_TEST_BENCH_WIRING 0
#define IP_SYNC_ORCA_ORCA_RESET_PIO_DRIVEN_SIM_VALUE 0
#define IP_SYNC_ORCA_ORCA_RESET_PIO_EDGE_TYPE NONE
#define IP_SYNC_ORCA_ORCA_RESET_PIO_FREQ 100000000
#define IP_SYNC_ORCA_ORCA_RESET_PIO_HAS_IN 0
#define IP_SYNC_ORCA_ORCA_RESET_PIO_HAS_OUT 1
#define IP_SYNC_ORCA_ORCA_RESET_PIO_HAS_TRI 0
#define IP_SYNC_ORCA_ORCA_RESET_PIO_IRQ_TYPE NONE
#define IP_SYNC_ORCA_ORCA_RESET_PIO_RESET_VALUE 0

/*
 * Macros for device 'ip_sync_orca', class 'ip_sync'
 * Path to the device is from the master group 'ipsync_bridge_orca'.
 * The macros are prefixed with 'IPSYNC_BRIDGE_ORCA_IP_SYNC_ORCA_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define IPSYNC_BRIDGE_ORCA_IP_SYNC_ORCA_COMPONENT_TYPE ip_sync
#define IPSYNC_BRIDGE_ORCA_IP_SYNC_ORCA_COMPONENT_NAME ip_sync_orca
#define IPSYNC_BRIDGE_ORCA_IP_SYNC_ORCA_BASE 0x0
#define IPSYNC_BRIDGE_ORCA_IP_SYNC_ORCA_SPAN 1024
#define IPSYNC_BRIDGE_ORCA_IP_SYNC_ORCA_END 0x3ff

/*
 * Macros for device 'orca_reset_pio', class 'altera_avalon_pio'
 * Path to the device is from the master group 'ipsync_to_orca_delay'.
 * The macros are prefixed with 'IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_COMPONENT_TYPE altera_avalon_pio
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_COMPONENT_NAME orca_reset_pio
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_BASE 0x0
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_SPAN 16
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_END 0xf
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_CAPTURE 0
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_DATA_WIDTH 32
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_DO_TEST_BENCH_WIRING 0
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_DRIVEN_SIM_VALUE 0
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_EDGE_TYPE NONE
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_FREQ 100000000
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_HAS_IN 0
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_HAS_OUT 1
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_HAS_TRI 0
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_IRQ_TYPE NONE
#define IPSYNC_TO_ORCA_DELAY_ORCA_RESET_PIO_RESET_VALUE 0

/*
 * Macros for device 'aux_data_mem', class 'altera_avalon_onchip_memory2'
 * Path to the device is from the master group 'orca_data'.
 * The macros are prefixed with 'ORCA_DATA_AUX_DATA_MEM_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define ORCA_DATA_AUX_DATA_MEM_COMPONENT_TYPE altera_avalon_onchip_memory2
#define ORCA_DATA_AUX_DATA_MEM_COMPONENT_NAME aux_data_mem
#define ORCA_DATA_AUX_DATA_MEM_BASE 0x0
#define ORCA_DATA_AUX_DATA_MEM_SPAN 131072
#define ORCA_DATA_AUX_DATA_MEM_END 0x1ffff
#define ORCA_DATA_AUX_DATA_MEM_ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR 0
#define ORCA_DATA_AUX_DATA_MEM_ALLOW_MRAM_SIM_CONTENTS_ONLY_FILE 0
#define ORCA_DATA_AUX_DATA_MEM_CONTENTS_INFO ""
#define ORCA_DATA_AUX_DATA_MEM_DUAL_PORT 0
#define ORCA_DATA_AUX_DATA_MEM_GUI_RAM_BLOCK_TYPE AUTO
#define ORCA_DATA_AUX_DATA_MEM_INIT_CONTENTS_FILE soc_system_aux_data_mem
#define ORCA_DATA_AUX_DATA_MEM_INIT_MEM_CONTENT 1
#define ORCA_DATA_AUX_DATA_MEM_INSTANCE_ID NONE
#define ORCA_DATA_AUX_DATA_MEM_NON_DEFAULT_INIT_FILE_ENABLED 0
#define ORCA_DATA_AUX_DATA_MEM_RAM_BLOCK_TYPE AUTO
#define ORCA_DATA_AUX_DATA_MEM_READ_DURING_WRITE_MODE DONT_CARE
#define ORCA_DATA_AUX_DATA_MEM_SINGLE_CLOCK_OP 0
#define ORCA_DATA_AUX_DATA_MEM_SIZE_MULTIPLE 1
#define ORCA_DATA_AUX_DATA_MEM_SIZE_VALUE 131072
#define ORCA_DATA_AUX_DATA_MEM_WRITABLE 1
#define ORCA_DATA_AUX_DATA_MEM_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define ORCA_DATA_AUX_DATA_MEM_MEMORY_INFO_GENERATE_DAT_SYM 1
#define ORCA_DATA_AUX_DATA_MEM_MEMORY_INFO_GENERATE_HEX 1
#define ORCA_DATA_AUX_DATA_MEM_MEMORY_INFO_HAS_BYTE_LANE 0
#define ORCA_DATA_AUX_DATA_MEM_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define ORCA_DATA_AUX_DATA_MEM_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define ORCA_DATA_AUX_DATA_MEM_MEMORY_INFO_MEM_INIT_FILENAME soc_system_aux_data_mem

/*
 * Macros for device 'uc_data_mem', class 'altera_avalon_onchip_memory2'
 * Path to the device is from the master group 'orca_axi_duc_axi_iuc'.
 * The macros are prefixed with 'ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_COMPONENT_TYPE altera_avalon_onchip_memory2
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_COMPONENT_NAME uc_data_mem
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_BASE 0x0
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_SPAN 2048
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_END 0x7ff
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR 0
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_ALLOW_MRAM_SIM_CONTENTS_ONLY_FILE 0
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_CONTENTS_INFO ""
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_DUAL_PORT 1
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_GUI_RAM_BLOCK_TYPE AUTO
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_INIT_CONTENTS_FILE soc_system_uc_data_mem
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_INIT_MEM_CONTENT 1
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_INSTANCE_ID NONE
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_NON_DEFAULT_INIT_FILE_ENABLED 0
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_RAM_BLOCK_TYPE AUTO
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_READ_DURING_WRITE_MODE DONT_CARE
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_SINGLE_CLOCK_OP 0
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_SIZE_MULTIPLE 1
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_SIZE_VALUE 2048
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_WRITABLE 1
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_MEMORY_INFO_GENERATE_DAT_SYM 1
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_MEMORY_INFO_GENERATE_HEX 1
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_MEMORY_INFO_HAS_BYTE_LANE 0
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define ORCA_AXI_DUC_AXI_IUC_UC_DATA_MEM_MEMORY_INFO_MEM_INIT_FILENAME soc_system_uc_data_mem

/*
 * Macros for device 'aux_inst_mem', class 'altera_avalon_onchip_memory2'
 * Path to the device is from the master group 'orca_instruction'.
 * The macros are prefixed with 'ORCA_INSTRUCTION_AUX_INST_MEM_'.
 * The prefix is the master group descriptor and the slave descriptor.
 */
#define ORCA_INSTRUCTION_AUX_INST_MEM_COMPONENT_TYPE altera_avalon_onchip_memory2
#define ORCA_INSTRUCTION_AUX_INST_MEM_COMPONENT_NAME aux_inst_mem
#define ORCA_INSTRUCTION_AUX_INST_MEM_BASE 0x0
#define ORCA_INSTRUCTION_AUX_INST_MEM_SPAN 131072
#define ORCA_INSTRUCTION_AUX_INST_MEM_END 0x1ffff
#define ORCA_INSTRUCTION_AUX_INST_MEM_ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR 0
#define ORCA_INSTRUCTION_AUX_INST_MEM_ALLOW_MRAM_SIM_CONTENTS_ONLY_FILE 0
#define ORCA_INSTRUCTION_AUX_INST_MEM_CONTENTS_INFO ""
#define ORCA_INSTRUCTION_AUX_INST_MEM_DUAL_PORT 0
#define ORCA_INSTRUCTION_AUX_INST_MEM_GUI_RAM_BLOCK_TYPE AUTO
#define ORCA_INSTRUCTION_AUX_INST_MEM_INIT_CONTENTS_FILE aes
#define ORCA_INSTRUCTION_AUX_INST_MEM_INIT_MEM_CONTENT 1
#define ORCA_INSTRUCTION_AUX_INST_MEM_INSTANCE_ID NONE
#define ORCA_INSTRUCTION_AUX_INST_MEM_NON_DEFAULT_INIT_FILE_ENABLED 1
#define ORCA_INSTRUCTION_AUX_INST_MEM_RAM_BLOCK_TYPE AUTO
#define ORCA_INSTRUCTION_AUX_INST_MEM_READ_DURING_WRITE_MODE DONT_CARE
#define ORCA_INSTRUCTION_AUX_INST_MEM_SINGLE_CLOCK_OP 0
#define ORCA_INSTRUCTION_AUX_INST_MEM_SIZE_MULTIPLE 1
#define ORCA_INSTRUCTION_AUX_INST_MEM_SIZE_VALUE 131072
#define ORCA_INSTRUCTION_AUX_INST_MEM_WRITABLE 1
#define ORCA_INSTRUCTION_AUX_INST_MEM_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define ORCA_INSTRUCTION_AUX_INST_MEM_MEMORY_INFO_GENERATE_DAT_SYM 1
#define ORCA_INSTRUCTION_AUX_INST_MEM_MEMORY_INFO_GENERATE_HEX 1
#define ORCA_INSTRUCTION_AUX_INST_MEM_MEMORY_INFO_HAS_BYTE_LANE 0
#define ORCA_INSTRUCTION_AUX_INST_MEM_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define ORCA_INSTRUCTION_AUX_INST_MEM_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define ORCA_INSTRUCTION_AUX_INST_MEM_MEMORY_INFO_MEM_INIT_FILENAME aes
